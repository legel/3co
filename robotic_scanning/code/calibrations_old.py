...
computers = ['pi_1', 'pi_2', 'udoo']
ip_address = {'pi_1': '192.168.0.87', 'pi_2': '192.168.0.167', 'udoo': ''}
network_channel_name = '3cobot'
axis_to_computer = {'x1': 'pi_1', 'x2': 'pi_1', 'x': 'pi_1', 'y': 'pi_2', 'z1': 'pi_2', 'z2': 'pi_2', 'z': 'pi_2', 'phi': 'pi_1', 'theta': 'pi_2', 'turn': 'pi_2','projector_focus': 'pi_1', 'camera_focus': 'pi_1', 'camera_aperture': 'pi_1'} # duplicate axis mappings (e.g. x1, x2 = x) not elegant 
...
motors = { 'x1':    {'inverse_coordinate': False, 'directional_correction': -1, 'positioning': 'manual_initialization', 'computer': 'pi_1', 'port': 3, 'microsteps': 32, 'max_speed': 300, 'accel': 15, 'decel': 15, 'hold_current': 70, 'run_current': 90,'acc_current': 100, 'dec_current': 100, 'motion': 'linear', 'steps_per_mm': 160, 'min': 0.0, 'max': 2.6},
           ...
           'z2':    {'inverse_coordinate': True, 'directional_correction': -1, 'positioning': 'recorded_motion', 'computer': 'pi_2', 'port': 1, 'microsteps': 16, 'max_speed': 500, 'accel': 100, 'decel': 100, 'hold_current': 50, 'run_current': 90,'acc_current': 100, 'dec_current': 100, 'motion': 'linear', 'steps_per_mm': 396.5, 'min': 0.000, 'max': 0.850},
