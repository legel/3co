...
axis_to_computer = {'x1': 'pi_2', 'x2': 'pi_2', 'x': 'pi_2', 'y': 'pi_2', 'z1': 'pi_2', 'z2': 'pi_2', 'z': 'pi_2', 'phi': 'pi_1', 'theta': 'pi_1', 'turn': 'pi_2','projector_focus': 'pi_1', 'camera_focus': 'pi_1', 'camera_aperture': 'pi_1', 'camera_polarization': 'pi_1', 'cali_z1': 'pi_3', 'cali_z2': 'pi_3', 'cali_z': 'pi_3', 'cali_x1': 'pi_3', 'cali_x2': 'pi_3', 'cali_x': 'pi_3', 'cali_y': 'pi_3', 'cali_turn': 'pi_3'}


# wiring and speed settings for each motor
motors = { 'x1':    {'inverse_coordinate': False, 'directional_correction': -1, 'positioning': 'manual_initialization', 'computer': 'pi_2', 'port': 3, 'microsteps': 32, 'max_speed': 300, 'accel': 15, 'decel': 15, 'hold_current': 70, 'run_current': 90,'acc_current': 100, 'dec_current': 100, 'motion': 'linear', 'steps_per_mm': 160, 'min': 0.0, 'max': 2.6},
           'x2':    {'inverse_coordinate': False, 'directional_correction': 1, 'positioning': 'manual_initialization', 'computer': 'pi_2', 'port': 4, 'microsteps': 32, 'max_speed': 300, 'accel': 15, 'decel': 15, 'hold_current': 70, 'run_current': 90,'acc_current': 100, 'dec_current': 100, 'motion': 'linear', 'steps_per_mm': 160, 'min': 0.0, 'max': 2.6},
