...
if __name__ == "__main__":
  ...
  lasers = Photonics(projectors_or_sensors="projectors", focal_point=Point(1.0, 1.0, 1.0), focal_length=0.01, pixel_size=0.001, vertical_pixels=10, horizontal_pixels=10, image="entropy_pico.png") # 64 x 114 / 768 x 1366 -> distance / width = 0.7272404614
