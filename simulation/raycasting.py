...
if __name__ == "__main__":  
  ...
  sensor_resolution = 0.3 # set to 1.0 for full resolution equivalent to our scanner
  ...
  model = "/Users/x/super_fresh_research/research/simulated_scanner_outputs/brownchair/brownchair/Zara_armchair_1.dae"

  environment.new_model(model)
  print("Location: {}".format(environment.model_object.location))
  outputs = scanner.scan(x=2.50, y=0.0, z=0.5, pitch=90, yaw=90, turntable=0)
